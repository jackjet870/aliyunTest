...
namespace aliyunTest.Framework.Database.FullData
{
    ...
    sealed class FullDataHelper
    {
        ...
        public DynamicMethod CreateFullObjMethod(IDataReader reader, Type type, bool isMap)
        {
            //创建动态方法
        ...
        /// <param name="type">映射类型</param>
        /// <param name="isMap">是否从映射类中填充</param>
        public DynamicMethod CreateFullListMethod(IDataReader reader, Type type, bool isMap)
        {
            DynamicMethod method = new DynamicMethod("Create",
        ...
        private void CreateBuilder(bool isMap, ILGenerator il, LocalBuilder item, LocalBuilder xml, IDataReader dataReader, Type type)
        {
            //调用T对象的构造函数,并赋予item
            ...
            if (isMap)
            {
                ...
                //获取表主键
                DBColumn pk = table.PrimaryKey;

                //获取主键在参数dataReader中的顺序号
                if (pk == null) throw new MyDBException(string.Format("实体【{0}】未映射主键", table.AliasName));
                ...
                foreach (DBColumn col in table.ColumnList)
                {
                    ...
                    fieldIndex = dataReader.GetOrdinal(col.Name);
        ...
        private void GetCharValue(ILGenerator il, Type fieldType, Type underlyingType)
        {
        ...
        /// <param name="fieldType">属性类型</param>
        /// <param name="underlyingType">Nullable中的底层类型</param>
        private void GetDecimalValue(ILGenerator il, Type fieldType, Type underlyingType)
        {
        ...
        private void GetStringValue(ILGenerator il, Type fieldType, Type underlyingType, LocalBuilder xml)
        {
        ...
        /// <param name="fieldType">属性类型</param>
        /// <param name="underlyingType">Nullable中的底层类型</param>
        private void GetDoubleValue(ILGenerator il, Type fieldType, Type underlyingType)
        {
        ...
        /// <param name="fieldType">属性类型</param>
        /// <param name="underlyingType">Nullable中的底层类型</param>
        private void GetFloatValue(ILGenerator il, Type fieldType, Type underlyingType)
        {
        ...
        /// <param name="fieldType">属性类型</param>
        /// <param name="underlyingType">Nullable中的底层类型</param>
        private void GetInt64Value(ILGenerator il, Type fieldType, Type underlyingType)
        {
        ...
        /// <param name="fieldType">属性类型</param>
        /// <param name="underlyingType">Nullable中的底层类型</param>
        private void GetInt32Value(ILGenerator il, Type fieldType, Type underlyingType)
        {
        ...
        /// <param name="fieldType">属性类型</param>
        /// <param name="underlyingType">Nullable中的底层类型</param>
        private void GetInt16Value(ILGenerator il, Type fieldType, Type underlyingType)
        {
        ...
        /// <param name="fieldType">属性类型</param>
        /// <param name="underlyingType">Nullable中的底层类型</param>
        private void GetByteValue(ILGenerator il, Type fieldType, Type underlyingType)
        {
        ...
        private void Ldc_I4(ILGenerator il, int i)
        {
        ...
        /// <param name="reader">IDataReader</param>
        /// <returns></returns>
        public string GetDataReaderInfo(IDataReader reader)
        {
        ...
        /// 动态类字典集合
        /// </summary>
        private Dictionary<string, Type> _idiDynamicType = new Dictionary<string, Type>();
        ...
        public Type CreateType(IDataReader reader)
        {
            //获取reader的字段信息
