...
namespace aliyunTest.Framework.Message
{
    /// <summary>
    /// 电子邮件发送
    /// </summary>
    public class Email
    {
        ...
        /// <returns></returns>
        public bool SendMail(string title, string body, EmailAddress toUser)
        {
            return SendMail(title, body, new List<EmailAddress> { toUser }, false);
        }
        ...
        /// <returns></returns>
        public bool SendMail(string title, string body, EmailAddress toUser, bool isPrivate)
        {
            return SendMail(title, body, new List<EmailAddress> { toUser }, isPrivate);
        }
        ...
        /// <returns></returns>
        public bool SendMail(string title, string body, EmailAddress toUser, bool isPrivate, bool isSsl)
        {
            return SendMail(title, body, new List<EmailAddress> { toUser }, isPrivate, isSsl);
        }
        ...
        /// <param name="isPrivate">是否隐密模式</param>
        /// <returns></returns>
        public bool SendMail(string title, string body, List<EmailAddress> toUsers, bool isPrivate)
        {
            return SendMail(title, body, toUsers, isPrivate, true);
        }
        ...
        /// <returns></returns>
        public bool SendMail(string title, string body, List<EmailAddress> toUsers, bool isPrivate, bool isSsl)
        {
